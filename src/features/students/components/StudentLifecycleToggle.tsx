/**
 * Toggle para cambiar el estado del ciclo de vida de un estudiante
...
import { changeStudentLifecycleStatus } from '../services/student.service';

interface StudentLifecycleToggleProps {
  record: Student;
}

export const StudentLifecycleToggle = ({ record }: StudentLifecycleToggleProps) => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      await changeStudentLifecycleStatus(record.id, pendingStatus);
